            ...
            <>
              ...
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Transparency & Responsibility
                  </div>
                  <div className="features-descr">
                  We uphold the highest standards of accountability, ensuring every project is delivered with full transparency and precision, so you can trust every step of the process.</div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Client Trust & Loyalty
                  </div>
                  <div className="features-descr">
                  Our unwavering commitment to excellence fosters long-lasting relationships built on trust, reliability, and consistent performance.                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
