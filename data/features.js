export const featureItems = [
  {
    ...
    title: "Unique Design",
    description:
      "Our designs stand out with innovative elements and tailored aesthetics that captivate and engage.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    title: "Quality Code",
    description:
      "We deliver high-standard, reliable code that ensures performance and stability for your projects.",
  },
  {
    id: 3,
    ...
    description:
      "Our approach emphasizes simplicity and clarity, creating streamlined and effective solutions that enhance user experience.",
  },
];
...
export const featuresListData = [
  ...
  { text: "Personal Blogs & Websites" },
  { text: "Conversion-Optimized Landing Pages" },
  { text: "PCreative Portfolios & Galleries" },
];
